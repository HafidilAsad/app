...
/* Bar 2 */
    { id: 20, top: '39%', left: '7.4%' },
    { id: 21, top: '39%', left: '12%' },
    ...
    { id: 37, top: '39%', left: '77.5%' },
    { id: 38, top: '39%', left: '81.5%' },

    /* Bar 3 */
    { id: 40, top: '54%', left: '7.4%' },
    { id: 41, top: '54%', left: '12%' },
    { id: 42, top: '54%', left: '16%' },
    { id: 43, top: '54%', left: '20%' },
    { id: 44, top: '54%', left: '24%' },
    { id: 45, top: '54%', left: '28%' },
    { id: 46, top: '54%', left: '32.5%' },
    { id: 47, top: '54%', left: '36%' },
    { id: 48, top: '54%', left: '40%' },
    { id: 49, top: '54%', left: '44%' },
    { id: 50, top: '54%', left: '48%' },
    { id: 51, top: '54%', left: '52.5%' },
    { id: 52, top: '54%', left: '56%' },
    { id: 53, top: '54%', left: '60.5%' },
    { id: 54, top: '54%', left: '64.5%' },
    { id: 55, top: '54%', left: '69%' },
    { id: 56, top: '54%', left: '73.5%' },
    { id: 57, top: '54%', left: '77.5%' },
    { id: 58, top: '54%', left: '81.5%' },

    /* Bar 4 */
    { id: 59, top: '77%', left: '7.4%' },
    { id: 61, top: '77%', left: '12%' },
    { id: 62, top: '77%', left: '16%' },
    { id: 63, top: '77%', left: '20%' },
    { id: 64, top: '77%', left: '24%' },
    { id: 65, top: '77%', left: '28%' },
    { id: 66, top: '77%', left: '32.5%' },
    { id: 67, top: '77%', left: '36%' },
    { id: 68, top: '77%', left: '40%' },
    { id: 69, top: '77%', left: '44%' },
    { id: 70, top: '77%', left: '48%' },
    { id: 71, top: '77%', left: '52.5%' },
    { id: 72, top: '77%', left: '56%' },
    { id: 73, top: '77%', left: '60.5%' },
    { id: 74, top: '77%', left: '64.5%' },
    { id: 75, top: '77%', left: '69%' },
    { id: 76, top: '77%', left: '73.5%' },
  ];
